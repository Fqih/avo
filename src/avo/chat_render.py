...
SLASH_COMMANDS: tuple[tuple[str, str], ...] = (
    ...
    ("/fix [TARGET]", "autonomously diagnose and repair failing tests in isolated worktree"),
    ...
    ("/pr [BASE]", "generate production-ready GitHub Pull Request draft from git diff"),
